// This is the entry point for all pages in the app

export { default as Classes } from "./Classes.svelte";
export { default as MakeAssessment } from "./MakeAssessment.svelte";
...
export { default as ManageAssessments } from "./Manage-Assessments.svelte";
